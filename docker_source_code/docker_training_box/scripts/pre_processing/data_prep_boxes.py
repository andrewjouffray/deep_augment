...
def main():
	...
	for trunc in range(int(truncate)):
		...
		if record.lower() == "true":
			...
			command = "python /scripts/pre_processing/xml_record.py -x "+ fold_path +"/train_xml -l "+path+"label.pbtxt -o "+fold_path+"/annotation/train.record -i "+fold_path+"/train_img"
			...
			command = "python /scripts/pre_processing/xml_record.py -x "+ fold_path +"/test_xml -l "+path+"label.pbtxt -o "+fold_path+"/annotation/test.record -i "+fold_path+"/test_img"
